...
def assign_hierarchical_labels(
    ...
    # Work on a private round-local copy. The complete AnnData remains owned by
    # the transfer orchestrator; this function return only indexed results.
