...
def generate_final_mask(prefix, he, mask1_updated, mask2, output_dir="HistoSweep_Output", clean_background = True, super_pixel_size=16, minSize = 10):
    ...
    if not output_path.is_absolute():
        output_path = Path(prefix) / output_path
    ...
    Image.fromarray(cleaned).save(output_path / "mask-small.png")
    ...
    Image.fromarray(mask_final).save(output_path / "mask.png")

    print("✅ Final masks saved in:", output_path)
